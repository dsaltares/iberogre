...
//! Clase para crear una escena simple de ejemplo de partículas con Ogre
 ...
 * sencilla con varios efectos de partículas entre las que podemos ir alternando.
 */
class EscenaSimple: public AplicacionOgre {
    ...
    private:
        ...
        // Partículas
        std::map<OIS::KeyCode, Ogre::String> teclasParticulas;
        Ogre::SceneNode* nodoParticulas;
        Ogre::ParticleSystem* particulas;
