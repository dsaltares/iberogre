...
//! Clase para crear una escena simple de ejemplo de iluminación, niebla y sombras con Ogre
 ...
 * sencilla con un modelo, un plano, algunas luces, niebla etc.
 */
class EscenaSimple: public AplicacionOgre {
    ...
    private:
        ...
        // Ténica de sombreado actual
        Ogre::String tecnicaSombra;
